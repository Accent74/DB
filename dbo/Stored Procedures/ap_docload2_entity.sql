----------------------------------------
create procedure ap_docload2_entity
@id int,
@sd datetime,
@ed datetime,
@mcid int
...
where JOURNAL.J_ENT=@id and DOCUMENTS.MC_ID=@mcid and DOCUMENTS.DOC_DONE < 100 and
  DOCUMENTS.DOC_DATE>=@sd and DOCUMENTS.DOC_DATE<@ed

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ap_docload2_entity] TO [ap_public]
    AS [dbo];
