----------------------------------------
create procedure ap_docload2_form
@id Int,
@sd datetime,
@ed datetime,
@mcid int
...
from DOCUMENTS
where DOCUMENTS.FRM_ID=@id and DOCUMENTS.MC_ID=@mcid and DOCUMENTS.DOC_DONE < 100 and
  DOCUMENTS.DOC_DATE>=@sd and DOCUMENTS.DOC_DATE<@ed

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ap_docload2_form] TO [ap_public]
    AS [dbo];
