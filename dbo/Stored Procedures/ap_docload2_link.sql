----------------------------------------
create procedure ap_docload2_link
@id int,
@mcid int
as
set nocount on
...
from DOCUMENTS
where DOCUMENTS.DOC_LINK=@id and DOCUMENTS.MC_ID=@mcid and DOCUMENTS.DOC_DONE < 100

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ap_docload2_link] TO [ap_public]
    AS [dbo];
