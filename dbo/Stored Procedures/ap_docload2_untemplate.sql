----------------------------------------
create procedure ap_docload2_untemplate
@sd datetime,
@ed datetime,
@mcid int
as
...
from DOCUMENTS
where (DOCUMENTS.TML_ID=0 or DOCUMENTS.TML_ID is null) and DOCUMENTS.MC_ID=@mcid and DOCUMENTS.DOC_DONE < 100 and
  DOCUMENTS.DOC_DATE>=@sd and DOCUMENTS.DOC_DATE<@ed

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ap_docload2_untemplate] TO [ap_public]
    AS [dbo];
