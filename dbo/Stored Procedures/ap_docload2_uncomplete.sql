----------------------------------------
create procedure ap_docload2_uncomplete
@sd datetime,
@ed datetime,
@mcid int
as
...
from DOCUMENTS
where DOCUMENTS.MC_ID=@mcid and (DOCUMENTS.DOC_DONE = 0 or DOCUMENTS.DOC_DONE=1) and
  DOCUMENTS.DOC_DATE>=@sd and DOCUMENTS.DOC_DATE<@ed

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ap_docload2_uncomplete] TO [ap_public]
    AS [dbo];
