----------------------------------------
create procedure ap_docload2_agent
@id int,
@sd datetime,
@ed datetime,
@mcid int
...
where (JOURNAL.J_AG1=@id or JOURNAL.J_AG2=@id)and DOCUMENTS.MC_ID=@mcid and DOCUMENTS.DOC_DONE < 100 and
  DOCUMENTS.DOC_DATE>=@sd and DOCUMENTS.DOC_DATE<@ed

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ap_docload2_agent] TO [ap_public]
    AS [dbo];
