----------------------------------------
create procedure ap_docload2_fldroot
@sd datetime,
@ed datetime,
@mcid int
as
...
from DOCUMENTS
where (DOCUMENTS.FLD_ID=0 or DOCUMENTS.FLD_ID is null) and DOCUMENTS.MC_ID=@mcid and DOCUMENTS.DOC_DONE < 100 and
  DOCUMENTS.DOC_DATE>=@sd and DOCUMENTS.DOC_DATE<@ed

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ap_docload2_fldroot] TO [ap_public]
    AS [dbo];
