...
---------------------------------------------------------------------
create procedure ap_tree_getkey
@et int,
@id int = 0,
@p0 int = 0,
@p1 int = 0,
...
select @sql = N'select PK, SHORTCUT from ' + @tbl + N' where ID=@id and ' +
	      N'P0=@p0 and P1=@p1 and P2=@p2 and P3=@p3 and ' +
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ap_tree_getkey] TO [ap_public]
    AS [dbo];
